...
/***/ function(module, exports, __webpack_require__) {
	...
	var socket = io(('http://tilscraper.azurewebsites.net:80'));
	...
	var Tweet = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'tweet-card col-md-8 col-md-offset-2' },
	        React.createElement(
	          'figure',
	          null,
	          React.createElement(
	...
	var Main = React.createClass({
	  ...
	  render: function () {
	    var tweetElements = this.state.tweets.map(function (tweet) {
	      return React.createElement(Tweet, { tweetText: tweet.text, author: tweet.author });
	    });
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'wait-for-it col-md-4 col-md-offset-4' },
	        React.createElement(
	          'span',
	          null,
	          tweetElements.length === 0 ? "Wait for it..." : ""
	        )
	      )
	    );
	  }
	...
	ReactDOM.render(React.createElement(Main, null), document.getElementById('reactContent'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseqs = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(179);
	var inherit = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(192);
	var inherit = __webpack_require__(201);
	var yeast = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!WebSocket && typeof window === 'undefined') {
	  try {
	    WebSocket = __webpack_require__(205);
	  } catch (e) {}
	}
